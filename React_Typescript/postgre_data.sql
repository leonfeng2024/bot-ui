...
CREATE VIEW employee_history_log AS 
SELECT 
    eh.history_id,  
    eh.employee_id,  
...
('employee_details', '従業員詳細', 'employees', '従業員'),
('employee_details', '従業員詳細', 'departments', '部門'),
('high_salary_employees', '高給与従業員', 'employees', '従業員'),
('active_accounts', '有効口座', 'accounts', '口座'),
('transaction_summary', '取引概要', 'transactions', '取引'),
('transaction_summary', '取引概要', 'accounts', '口座'),
('employee_history_log', '従業員履歴ログ', 'employees_history', '従業員履歴'),
('employee_history_log', '従業員履歴ログ', 'employees', '従業員');
...
('dataset_employee', '従業員データセット', 'employee_details', '従業員詳細'),
('dataset_account', '口座データセット', 'accounts', '口座'),
('dataset_account', '口座データセット', 'active_accounts', '有効口座'),
('dataset_transaction', '取引データセット', 'transactions', '取引'),
('dataset_transaction', '取引データセット', 'transaction_summary', '取引概要'),
('dataset_history', '履歴データセット', 'employees_history', '従業員履歴'),
('dataset_history', '履歴データセット', 'employee_history_log', '従業員履歴ログ');